...
<!--                                           <a href="{{ route('stock_category.edit',$data->id)}}" class="btn btn-dark btn-sm">
                                          ...
                                          <a type="button" class="btn btn-danger btn-sm modalDeleteButton" data-form-action="{{url('assets/'.$data->id)}}" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal1">
