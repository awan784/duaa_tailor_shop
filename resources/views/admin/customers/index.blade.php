                                  ...
                                  <tbody>
                                    @foreach ($totalData as $key => $data)
                                      <tr>
                                        ...
                                        <td>{{$data->phone}}</td>
                                        <td class="td-width">
                                          <a href="{{ route('customer.ledger',$data->id)}}" class="btn text-dark pe-1">
                                            <i class="fa fa-eye"></i>
                                          </a>
                                          <a href="{{ route('customers.edit',$data->id)}}" class="btn btn-dark btn-sm">
                                            <i class="fa fa-edit"></i>
                                          </a>
                                          <a type="button" class="btn btn-danger btn-sm modalDeleteButton" data-form-action="{{url('customers/'.$data->id)}}" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal1">
