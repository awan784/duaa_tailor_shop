                              ...
                              <div class="white_box_tittle list_header">
                                ...
                                <div class="box_right d-flex lms_block">
                                  ...
                                  <div class="add_button ms-2">
                                    <a
                                      href="{{route('stock_category.create')}}"
                                      class="btn_1"
                                      >Add New</a
                                    >
                                  </div>
                                  ...
                                  <tbody>
                                    @foreach ($totalData as $key => $data)
                                      <tr>
                                        ...
                                        <td class="td-width">
                                          <a href="{{ route('stock_category.edit',$data->id)}}" class="btn btn-dark btn-sm">
                                            <i class="fa fa-edit"></i>
                                          </a>
                                          <a type="button" class="btn btn-danger btn-sm modalDeleteButton" data-form-action="{{url('stock_category/'.$data->id)}}" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal1">
