                                  ...
                                  <tbody>
                                    @foreach ($totalData as $key => $data)
                                      <tr>
                                        ...
                                        <td class="td-width">
                                          <a href="{{ route('stock_unit.edit',$data->id)}}" class="btn btn-dark btn-sm">
                                            <i class="fa fa-edit"></i>
                                          </a>
                                          <a type="button" class="btn btn-danger btn-sm modalDeleteButton" data-form-action="{{url('stock_unit/'.$data->id)}}" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal1">
