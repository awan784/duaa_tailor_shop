                            ...
                            <div class="col-lg-6">
                                <div class="dashboard_breadcam text-end">
                                    <p>
                                        ...
                                        <i class="fas fa-caret-right"></i> Add Stocks
                                    </p>
                                </div>
                            </div>
                        </div>
...
<!--                                         <div class="col-md-6 mt-3">
                                            ...
                                            <input name="sale_price" type="number" step="0.0001" value="0" class="form-control" id="sale_price" placeholder="Sale Price" required/>
                                        </div> -->
                                        <div class="col-md-6 mt-3">
                                            <label class="form-label" for="quantity">Quantity</label>
                                            <input name="quantity" type="number" value="{{ old('quantity') }}" class="form-control" id="quantity" placeholder="Quantity" step="any" required />
                                        </div>
                                        {{-- <div class="col-md-6 mt-3">
